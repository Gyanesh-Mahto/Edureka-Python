...
print(os.name)  #posix: Returns the name of the OS dependent module imported

print(os.environ)   #Environment: Returns a mapping object representing a string environment

print(os.getppid())     #507: Returns the parent's process id
